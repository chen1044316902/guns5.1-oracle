# Guns V5.1 oracle 版本
## 请执行下面操作以支持oracle
> * 解压styledeng.rar 把解压后的文件夹放到maven本地仓库cn下面，复制的时候选择替换选项
> * 把gunstest.sql导入，然后导入gunstest.dmp
> * 所需文件都在lib文件下面
> * 为了支持oracle 主要修改了guns作者的guns-generator 和 rose-kernal 下的kernal-core两个项目
...
## 曾获荣誉
![输入图片说明](https://gitee.com/uploads/images/2017/1015/151932_f1593f87_551203.jpeg "initpintu_副本_副本.jpg")# guns5.1-oracle
